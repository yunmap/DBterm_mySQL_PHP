...
include "lock.php";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){ 
      ...
      //echo $key;
      $sql="SELECT * FROM 2017dbterm.pfood WHERE type LIKE '%$key%' or pID like '%$key%'";
      $result = mysql_query($sql);
      echo '<center><table class="tg"><thead><tr><th class="tg-huad">선물 번호</th><th class="tg-huad">음식 이름</th><th class="tg-huad">가격</th><th class="tg-huad">남은 수량</th></tr></thead><tbody>';
      if ($result != false) {

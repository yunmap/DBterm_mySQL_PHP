...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($pID1<50000) {
      $sql1="INSERT INTO 2017dbterm.pfood (pID, money, count, type) VALUES ('$pID1', '$money1', '$count1', '$name1')";
      mysql_query($sql1);
...
<center><h4>상품(음식) 등록</h4>
<table class="tg">
  <form action="" method="post">
  <thead>
    <tr>
      <th class="tg-huad">음식 번호</th>
